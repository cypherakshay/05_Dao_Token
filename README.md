...
## **Project 05 -**  DAO Token `(static page)`
...
This project is a website to get a DAO (decentralised autonomous organizations) token. In this project, I learned to create customize Nav-bar with strip color and more control over specific letter to beautify with CSS. I also learned to use creativity with code and use of Flex-Grow properties of CSS with positioning of image and text-align property to get the line break part on center of parent line, which makes the task significantly easier.
...
![Project Snapshot](./assets/05_thumbnail.png)
...
[<img alt="Go Live" width="170px" src="https://user-images.githubusercontent.com/110058268/192381169-8441c110-50f4-43a0-9ab1-b4cd6c509f95.png" />](https://cypherakshay-dao-token.netlify.app/ "Go Live")
